...
@section('content')
    @if (!empty($company_partners_array))
        <h4>Контрагенты</h4>
        @can('user_can_add_or_remove_partner')
            <a href="#" class="d-inline-flex align-items-center text-end btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#add">
                            ...
                            <div class="modal fade" id="delete" tabindex="-1" aria-labelledby="dynamicFormModalLabel"
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="dynamicFormModalLabel">Вы уверены что хотите
                                                удалить?
                                            </h5>
                                        </div>
    ...
    @else
        <div class="text-center text-secondary">
            <h2>Контрагенты не добавлены</h2>
            @can('user_can_add_or_remove_partner')
                ...
                <div class="modal fade" id="add" tabindex="-1" aria-labelledby="dynamicFormModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
